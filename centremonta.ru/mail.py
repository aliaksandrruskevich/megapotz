...
mail.send_mail(sender="Example.com Support <hello@otdelkalux.ru>",
              to="Albert Johnson <mike.shestakov@gmail.com>",
...
class SendMail(webapp2.RequestHandler):
    ...
    def post(self):
mail.send_mail(sender="Сергей Петунин <hello@otdelkalux.ru>",
...
<p>Полный и актуальный список объектов, на которых мы сейчас работаем, можно найти здесь: <a href="http://www.otdelkalux.ru/portfolio/process/?utm_source=estimate&utm_medium=email&utm_campaign=otdelkalux">www.otdelkalux.ru/portfolio/process/</a>.</p>
...
area:400
wc:3
name:Михаил Шестаков
email:mike.shestakov@gmail.com
html:<thead><tr><th></th><th>Бизнес</th><th>Люкс</th></tr></thead><tfoot><tr><td>Общая сумма (работа + материал)</td><td>5 362 750</td><td>6 310 000</td></tr></tfoot><tbody><tr><td>Отделка под ключ</td><td>2 800 000</td><td>3 400 000</td></tr><tr><td>Электрика под ключ</td><td>228 000</td><td>248 000</td></tr><tr><td>Сантехника под ключ</td><td>126 000</td><td>147 000</td></tr><tr><td>Отопление под ключ</td><td>190 000</td><td>210 000</td></tr><tr><td>Черновой материал отделка</td><td>1 400 000</td><td>1 600 000</td></tr><tr><td>Черновой материал электрика</td><td>120 000</td><td>140 000</td></tr><tr><td>Черновой материал сантехника</td><td>78 750</td><td>105 000</td></tr><tr><td>Черновой материал отопление</td><td>420 000</td><td>460 000</td></tr></tbody>